...
def pedigri(texto: str) -> dict:
    ...
    return {
        ...
        "identidad": {
            ...
            "lote_id": art.get("lote_id") or art.get("lote"),
            "nro_lote": art.get("nro_lote"),
            "chacra_id": art.get("chacra_id"),
            "lote_padre_id": art.get("lote_padre_id"),
            "color_bolsa": art.get("color_bolsa"),
            "color_hilo": art.get("color_hilo"),
            "variedad": art.get("variedad"),
            "categoria": art.get("categoria_semilla"),
            "clase": art.get("clase"),
            "campania": art.get("campania"),
            "calibre_comercial": art.get("calibre_comercial"),
