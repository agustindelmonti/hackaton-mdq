...
if "POLPILOT_DATA_DIR" not in os.environ:
    ...
    # La planilla real importada, si está. Se COPIA (no se linkea) para que la
    # suite no pueda tocar el seed versionado, igual que todo lo demás.
    _real = os.path.join(_origen, "real")
