...
CATALOGO: dict[str, dict[str, str]] = {
    ...
    "modulo.gestion_ubicaciones": {"es": "Gestión de ubicaciones (crear, editar, eliminar)",
                                   "en": "Location management (create, edit, delete)"},
    ...
    "audit.acc.crear_ubicacion": {"es": "Creó una ubicación nueva",
                                  "en": "Created a new location"},
    "audit.acc.editar_ubicacion": {"es": "Editó una ubicación",
                                   "en": "Edited a location"},
    "audit.acc.eliminar_ubicacion": {"es": "Eliminó una ubicación",
                                     "en": "Deleted a location"},
