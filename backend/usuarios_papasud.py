...
_TODO = [
    "panel", "disponibilidad", "mapa", "cerebro", "inventario", "deposito",
    "movimientos", "conciliacion",
...
USUARIOS = {
    ...
    "dalia": {
        ...
        "features": ["disponibilidad", "alertas", "angela", "cerebro"
                     "conciliacion", "deposito", "documentos", "inventario"
                     "perfil", "trazabilidad"],
    },
    "nestor": {
