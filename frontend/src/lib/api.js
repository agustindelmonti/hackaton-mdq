...
export const api = {
  ...
  cerebroMapa: () => get("/api/cerebro/mapa"),
  cerebroNodo: (nid) => get(`/api/cerebro/mapa/nodo/${encodeURIComponent(nid)}`),
  cerebroLote: (lote) => get(`/api/cerebro/lote/${encodeURIComponent(lote)}`),
